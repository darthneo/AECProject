...
public class BruneiActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.brunei_layout);
       ...
       btnGreet.setOnClickListener(new OnClickListener() {
		public void onClick(View v) {
			...
			Intent goGreet = new Intent(getApplicationContext(),dat1BruneiActivity.class);
       ...
       btnDay.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent goDays = new Intent(getApplicationContext(),dat2BruneiActivity.class);
       ...
       btnMonth.setOnClickListener(new OnClickListener() {
      		...
      		public void onClick(View v) {
      			// TODO Auto-generated method stub
      			Intent goMonth = new Intent(getApplicationContext(),dat3BruneiActivity.class);
       ...
       btnNumber.setOnClickListener(new OnClickListener() {
     		...
     		public void onClick(View v) {
     			// TODO Auto-generated method stub
     			Intent goNumber = new Intent(getApplicationContext(),dat4BruneiActivity.class);
       ...
       btnGoodbye.setOnClickListener(new OnClickListener() {
    		...
    		public void onClick(View v) {
    			// TODO Auto-generated method stub
    			Intent goGoodbye = new Intent(getApplicationContext(),dat5BruneiActivity.class);
