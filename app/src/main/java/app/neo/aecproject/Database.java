...
class Database extends SQLiteOpenHelper {
    ...
    public static final String Philipines = "philipines";
    ...
    public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE "+ Thailand 
		...
		//Greet TH
		db.execSQL("INSERT INTO "+ Thailand +" (" + COL_COUNTRY 
		...
		db.execSQL("INSERT INTO "+ Thailand +" (" + COL_COUNTRY 
				...
				db.execSQL("CREATE TABLE " + Brunei + 
					       "(_id INTEGER PRIMARY KEY AUTOINCREMENT," 
					       + COL_COUNTRY + " TEXT, " + COL_TYPE + " TEXT, " 
		        			+ COL_AMOUNT + " TEXT, " + COL_MEAN + " TEXT);");
				...
				//Greet BN
				db.execSQL("INSERT INTO "+ Brunei +" (" + COL_COUNTRY 
						+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
				...
				//KH
				db.execSQL("CREATE TABLE " + Cambodia + 
					       "(_id INTEGER PRIMARY KEY AUTOINCREMENT," 
					       + COL_COUNTRY + " TEXT, " + COL_TYPE + " TEXT, " 
		        			+ COL_AMOUNT + " TEXT, " + COL_MEAN + " TEXT);");
				
				//Greet KH
				db.execSQL("INSERT INTO "+ Cambodia +" (" + COL_COUNTRY 
						+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
				...
				//Greet ID
				db.execSQL("INSERT INTO "+ Indonesia +" (" + COL_COUNTRY 
						+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
				...
				//Greet LA
				db.execSQL("INSERT INTO "+ Laos +" (" + COL_COUNTRY 
							+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
				...
				//MY
				db.execSQL("CREATE TABLE " + Malaysia + 
					       "(_id INTEGER PRIMARY KEY AUTOINCREMENT," 
					       + COL_COUNTRY + " TEXT, " + COL_TYPE + " TEXT, " 
		        			+ COL_AMOUNT + " TEXT, " + COL_MEAN + " TEXT);");
				
				//Greet MY
				db.execSQL("INSERT INTO "+ Malaysia +" (" + COL_COUNTRY 
						+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
				...
				//MM
				db.execSQL("CREATE TABLE " + Myanmar + 
					       "(_id INTEGER PRIMARY KEY AUTOINCREMENT," 
					       + COL_COUNTRY + " TEXT, " + COL_TYPE + " TEXT, " 
		        			+ COL_AMOUNT + " TEXT, " + COL_MEAN + " TEXT);");
				
				//Greet MM
				db.execSQL("INSERT INTO "+ Myanmar +" (" + COL_COUNTRY 
						+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
				...
				//PH
				db.execSQL("CREATE TABLE " + Philipines + 
					       "(_id INTEGER PRIMARY KEY AUTOINCREMENT," 
					       + COL_COUNTRY + " TEXT, " + COL_TYPE + " TEXT, " 
		        			+ COL_AMOUNT + " TEXT, " + COL_MEAN + " TEXT);");
				
				//Greet PH
				db.execSQL("INSERT INTO "+ Philipines +" (" + COL_COUNTRY 
						+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
				...
				//SG
				db.execSQL("CREATE TABLE " + Singapore + 
					       "(_id INTEGER PRIMARY KEY AUTOINCREMENT," 
					       + COL_COUNTRY + " TEXT, " + COL_TYPE + " TEXT, " 
		        			+ COL_AMOUNT + " TEXT, " + COL_MEAN + " TEXT);");
				
				//Greet SG
				db.execSQL("INSERT INTO "+ Singapore +" (" + COL_COUNTRY 
						+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
				...
				//VN
				db.execSQL("CREATE TABLE " + Vietnam + 
					       "(_id INTEGER PRIMARY KEY AUTOINCREMENT," 
					       + COL_COUNTRY + " TEXT, " + COL_TYPE + " TEXT, " 
		        			+ COL_AMOUNT + " TEXT, " + COL_MEAN + " TEXT);");
				...
				//Greet VN
				db.execSQL("INSERT INTO "+ Vietnam +" (" + COL_COUNTRY 
						+ ", " + COL_TYPE  + ", " + COL_AMOUNT + ", " + COL_MEAN 
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS "+ Thailand);
        db.execSQL("DROP TABLE IF EXISTS "+ Brunei);
        db.execSQL("DROP TABLE IF EXISTS "+ Cambodia);
        db.execSQL("DROP TABLE IF EXISTS "+ Indonesia);
        db.execSQL("DROP TABLE IF EXISTS "+ Laos);
        db.execSQL("DROP TABLE IF EXISTS "+ Malaysia);
        db.execSQL("DROP TABLE IF EXISTS "+ Myanmar);
        db.execSQL("DROP TABLE IF EXISTS "+ Philipines);
        db.execSQL("DROP TABLE IF EXISTS "+ Singapore);
        db.execSQL("DROP TABLE IF EXISTS "+ Vietnam); 
        onCreate(db); 
	}
