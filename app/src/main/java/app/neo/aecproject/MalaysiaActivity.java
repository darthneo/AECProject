...
public class MalaysiaActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.malaysia_layout);
       ...
       btnGreet.setOnClickListener(new OnClickListener() {
		public void onClick(View v) {
			...
			Intent goGreet = new Intent(getApplicationContext(),dat1MalaysiaActivity.class);
       ...
       btnDay.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent goDays = new Intent(getApplicationContext(),dat2MalaysiaActivity.class);
       ...
       btnMonth.setOnClickListener(new OnClickListener() {
      		...
      		public void onClick(View v) {
      			// TODO Auto-generated method stub
      			Intent goMonth = new Intent(getApplicationContext(),dat3MalaysiaActivity.class);
       ...
       btnNumber.setOnClickListener(new OnClickListener() {
     		...
     		public void onClick(View v) {
     			// TODO Auto-generated method stub
     			Intent goNumber = new Intent(getApplicationContext(),dat4MalaysiaActivity.class);
       ...
       btnGoodbye.setOnClickListener(new OnClickListener() {
    		...
    		public void onClick(View v) {
    			// TODO Auto-generated method stub
    			Intent goGoodbye = new Intent(getApplicationContext(),dat5MalaysiaActivity.class);
