...
public class SingaporeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       btnGreet.setOnClickListener(new OnClickListener() {
		public void onClick(View v) {
			...
			Intent goGreet = new Intent(getApplicationContext(),dat1SingaporeActivity.class);
       ...
       btnDay.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent goDays = new Intent(getApplicationContext(),dat2SingaporeActivity.class);
       ...
       btnMonth.setOnClickListener(new OnClickListener() {
      		...
      		public void onClick(View v) {
      			// TODO Auto-generated method stub
      			Intent goMonth = new Intent(getApplicationContext(),dat3SingaporeActivity.class);
       ...
       btnNumber.setOnClickListener(new OnClickListener() {
     		...
     		public void onClick(View v) {
     			// TODO Auto-generated method stub
     			Intent goNumber = new Intent(getApplicationContext(),dat4SingaporeActivity.class);
       ...
       btnGoodbye.setOnClickListener(new OnClickListener() {
    		...
    		public void onClick(View v) {
    			// TODO Auto-generated method stub
    			Intent goGoodbye = new Intent(getApplicationContext(),dat5SingaporeActivity.class);
