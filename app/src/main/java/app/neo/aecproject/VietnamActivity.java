...
public class VietnamActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vietnam_layout);
       ...
       btnGreet.setOnClickListener(new OnClickListener() {
		public void onClick(View v) {
			...
			Intent goGreet = new Intent(getApplicationContext(),dat1VietnamActivity.class);
       ...
       btnDay.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent goDays = new Intent(getApplicationContext(),dat2VietnamActivity.class);
       ...
       btnMonth.setOnClickListener(new OnClickListener() {
      		...
      		public void onClick(View v) {
      			// TODO Auto-generated method stub
      			Intent goMonth = new Intent(getApplicationContext(),dat3VietnamActivity.class);
       ...
       btnNumber.setOnClickListener(new OnClickListener() {
     		...
     		public void onClick(View v) {
     			// TODO Auto-generated method stub
     			Intent goNumber = new Intent(getApplicationContext(),dat4VietnamActivity.class);
       ...
       btnGoodbye.setOnClickListener(new OnClickListener() {
    		...
    		public void onClick(View v) {
    			// TODO Auto-generated method stub
    			Intent goGoodbye = new Intent(getApplicationContext(),dat5VietnamActivity.class);
