...
public class dat1BruneiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datbrunei1_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Brunei 
		        + " WHERE " + Database.COL_TYPE + "='Brunei1'" 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btngoodmorningbn);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1BruneiActivity.this, R.raw.goodmorningbn);
			}
		
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btngoodafternoonbn);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1BruneiActivity.this, R.raw.goodafternoonbn);
			}
		});
		
		Button buttonSound3 = (Button)findViewById(R.id.btngoodeveningbn);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1BruneiActivity.this, R.raw.goodeveningbn);
			}
		});
