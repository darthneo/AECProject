...
public class dat1CambodiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datcambodia1_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Cambodia 
		        + " WHERE " + Database.COL_TYPE + "='Cambodia1'" 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1CambodiaActivity.this, R.raw.hellokh);
			}
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1CambodiaActivity.this, R.raw.howareyoukh);
			}
