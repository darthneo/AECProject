...
public class dat1IndonesiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datindo1_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Indonesia 
		        + " WHERE " + Database.COL_TYPE + "='Indonesia1'" 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btngoodmorningid);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1IndonesiaActivity.this, R.raw.goodmorningid);
			}
		
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btngoodafternoonid);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1IndonesiaActivity.this, R.raw.goodafternoonid);
			}
		});
		
		Button buttonSound3 = (Button)findViewById(R.id.btngoodeveningid);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1IndonesiaActivity.this, R.raw.goodeveningid);
			}
		});
