...
public class dat1LaosActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datlaos1_layout);
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnhellola);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1LaosActivity.this, R.raw.hellola);
			}
		
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnhowareyoula);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1LaosActivity.this, R.raw.howareyoula);
			}
		});
