...
public class dat1MalaysiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datmalaysia1_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Malaysia 
		        + " WHERE " + Database.COL_TYPE + "='Malaysia1'" 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btngoodmorningmy);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1MalaysiaActivity.this, R.raw.goodmorningmy);
			}
		
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btngoodafternoonmy);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1MalaysiaActivity.this, R.raw.goodafternoonmy);
			}
		});
		
		Button buttonSound3 = (Button)findViewById(R.id.btngoodeveningmy);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1MalaysiaActivity.this, R.raw.goodeveningmy);
			}
		});
