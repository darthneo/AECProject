...
public class dat1MyanmarActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datmyanmar1_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Myanmar 
		        + " WHERE " + Database.COL_TYPE + "='Myanmar1'" 
		...
		Button buttonSound1 = (Button)findViewById(R.id.btnhello);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1MyanmarActivity.this, R.raw.hellomm);
			}
		
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnhowareyou);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1MyanmarActivity.this, R.raw.howareyoumm);
			}
