...
public class dat1PhilipinesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datphilipines1_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Philipines 
		        + " WHERE " + Database.COL_TYPE + "='Philipines1'" 
		...
		Button buttonSound1 = (Button)findViewById(R.id.btnhelloph);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1PhilipinesActivity.this, R.raw.helloph);
			}
		
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btngoodmorningph);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1PhilipinesActivity.this, R.raw.goodmorningph);
			}
		
		});
		
		
		Button buttonSound3 = (Button)findViewById(R.id.btngoodafternoonph);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1PhilipinesActivity.this, R.raw.goodafternoonph);
			}
		});
		
		Button buttonSound4 = (Button)findViewById(R.id.btngoodeveningph);
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1PhilipinesActivity.this, R.raw.goodeveningph);
			}
		});
