...
public class dat1SingaporeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datsingapore1_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Singapore 
		        + " WHERE " + Database.COL_TYPE + "='Singapore1'" 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1SingaporeActivity.this, R.raw.hellosg);
			}
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1SingaporeActivity.this, R.raw.howareyousg);
			}
