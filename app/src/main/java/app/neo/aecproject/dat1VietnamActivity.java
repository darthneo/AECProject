...
public class dat1VietnamActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datvietnam1_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Vietnam 
		        + " WHERE " + Database.COL_TYPE + "='Vietnam1'" 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1VietnamActivity.this, R.raw.hellovn);
			}
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat1VietnamActivity.this, R.raw.howareyouvn);
			}
