...
public class dat2CambodiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datcambodia2_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Cambodia 
		        + " WHERE " + Database.COL_TYPE + "='Cambodia2'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2CambodiaActivity.this, R.raw.mondaykh);    
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2CambodiaActivity.this, R.raw.tuesdaykh);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2CambodiaActivity.this, R.raw.wednesdaykh);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2CambodiaActivity.this, R.raw.thursdaykh);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2CambodiaActivity.this, R.raw.fridaykh);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2CambodiaActivity.this, R.raw.saturdaykh);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2CambodiaActivity.this, R.raw.sundaykh);
			}
		});
