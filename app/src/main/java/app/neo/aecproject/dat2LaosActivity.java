...
public class dat2LaosActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datlaos2_layout);
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnMondayLA);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2LaosActivity.this, R.raw.mondayla);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnTuesdayLA);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2LaosActivity.this, R.raw.tuesdayla);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnWednesdayLA);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2LaosActivity.this, R.raw.wednesdayla);
			}
		});
				
		Button buttonSound4 = (Button)findViewById(R.id.btnThursdayLA);
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2LaosActivity.this, R.raw.thursdayla);
			}
		});
				
		
		Button buttonSound5 = (Button)findViewById(R.id.btnFridayLA);
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2LaosActivity.this, R.raw.fridayla);
			}
		});

		
		Button buttonSound6 = (Button)findViewById(R.id.btnSaturdayLA);
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2LaosActivity.this, R.raw.saturdayla);
			}
		});

		
		Button buttonSound7 = (Button)findViewById(R.id.btnSundayLA);
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2LaosActivity.this, R.raw.sundayla);
			}
		});
