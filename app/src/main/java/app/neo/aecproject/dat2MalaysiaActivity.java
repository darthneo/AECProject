...
public class dat2MalaysiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datmalaysia2_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Malaysia 
		        + " WHERE " + Database.COL_TYPE + "='Malaysia2'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnMondayMY);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MalaysiaActivity.this, R.raw.mondaymy);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnTuesdayMY);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MalaysiaActivity.this, R.raw.tuesdaymy);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnWednesdayMY);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MalaysiaActivity.this, R.raw.wednesdaymy);
			}
		});
				
		Button buttonSound4 = (Button)findViewById(R.id.btnThursdayMY);
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MalaysiaActivity.this, R.raw.thursdaymy);
			}
		});
				
		
		Button buttonSound5 = (Button)findViewById(R.id.btnFridayMY);
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MalaysiaActivity.this, R.raw.fridaymy);
			}
		});

		
		Button buttonSound6 = (Button)findViewById(R.id.btnSaturdayMY);
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MalaysiaActivity.this, R.raw.saturdaymy);
			}
		});

		
		Button buttonSound7 = (Button)findViewById(R.id.btnSundayMY);
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MalaysiaActivity.this, R.raw.sundaymy);
			}
		});
