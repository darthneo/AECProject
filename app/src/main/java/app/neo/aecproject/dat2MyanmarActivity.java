...
public class dat2MyanmarActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datmyanmar2_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Myanmar 
		        + " WHERE " + Database.COL_TYPE + "='Myanmar2'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MyanmarActivity.this, R.raw.mondaymm);    
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MyanmarActivity.this, R.raw.tuesdaymm);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MyanmarActivity.this, R.raw.wednesdaymm);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MyanmarActivity.this, R.raw.thursdaymm);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MyanmarActivity.this, R.raw.fridaymm);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MyanmarActivity.this, R.raw.saturdaymm);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2MyanmarActivity.this, R.raw.sundaymm);
			}
		});
