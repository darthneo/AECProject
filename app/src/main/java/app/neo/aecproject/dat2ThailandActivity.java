...
public class dat2ThailandActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datthai2_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Thailand 
		        + " WHERE " + Database.COL_TYPE + "='Thailand2'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnMondayTH);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2ThailandActivity.this, R.raw.mondayth);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnTuesdayTH);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2ThailandActivity.this, R.raw.tuesdayth);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnWednesdayTH);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2ThailandActivity.this, R.raw.wednesdayth);
			}
		});
				
		Button buttonSound4 = (Button)findViewById(R.id.btnThursdayTH);
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2ThailandActivity.this, R.raw.thursdayth);
			}
		});
				
		
		Button buttonSound5 = (Button)findViewById(R.id.btnFridayTH);
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2ThailandActivity.this, R.raw.fridayth);
			}
		});

		
		Button buttonSound6 = (Button)findViewById(R.id.btnSaturdayTH);
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2ThailandActivity.this, R.raw.saturdayth);
			}
		});

		
		Button buttonSound7 = (Button)findViewById(R.id.btnSundayTH);
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2ThailandActivity.this, R.raw.sundayth);
			}
		});
