...
public class dat2VietnamActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datvietnam2_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Vietnam 
		        + " WHERE " + Database.COL_TYPE + "='Vietnam2'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2VietnamActivity.this, R.raw.mondayvn);    
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2VietnamActivity.this, R.raw.tuesdayvn);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2VietnamActivity.this, R.raw.wednesdayvn);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2VietnamActivity.this, R.raw.thursdayvn);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2VietnamActivity.this, R.raw.fridayvn);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2VietnamActivity.this, R.raw.saturdayvn);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat2VietnamActivity.this, R.raw.sundayvn);
			}
		});
