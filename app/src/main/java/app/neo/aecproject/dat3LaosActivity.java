...
public class dat3LaosActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datlaos3_layout);
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnJanuaryLA);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.januaryla);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnFebruaryLA);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.februaryla);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnMarchLA);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.marchla);
			}
		});
				
		Button buttonSound4 = (Button)findViewById(R.id.btnAprilLA);
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.aprilla);
			}
		});
				
		
		Button buttonSound5 = (Button)findViewById(R.id.btnMayLA);
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.mayla);
			}
		});

		
		Button buttonSound6 = (Button)findViewById(R.id.btnJuneLA);
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.junela);
			}
		});

		
		Button buttonSound7 = (Button)findViewById(R.id.btnJulyLA);
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.julyla);
			}
		});
		
		Button buttonSound8 = (Button)findViewById(R.id.btnAugustLA);
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.augustla);
			}
		});
		
		Button buttonSound9 = (Button)findViewById(R.id.btnSeptemberLA);
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.septemberla);
			}
		});
		
		Button buttonSound10 = (Button)findViewById(R.id.btnOctoberLA);
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.octoberla);
			}
		});
		
		Button buttonSound11 = (Button)findViewById(R.id.btnNovemberLA);
		buttonSound11.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.novemberla);
			}
		});
		
		Button buttonSound12 = (Button)findViewById(R.id.btnDecemberLA);
		buttonSound12.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3LaosActivity.this, R.raw.decemberla);
			}
		});
