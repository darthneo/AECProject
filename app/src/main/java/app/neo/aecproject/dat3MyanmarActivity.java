...
public class dat3MyanmarActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datmyanmar3_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Myanmar 
		        + " WHERE " + Database.COL_TYPE + "='Myanmar3'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.januarymm);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.februarymm);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.marchmm);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.aprilmm);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.maymm);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.junemm);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.julymm);
			}
		});
		...
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.augustmm);
			}
		});
		...
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.septembermm);
			}
		});
		...
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.octobermm);
			}
		});
		...
		buttonSound11.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.novembermm);
			}
		});
		...
		buttonSound12.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3MyanmarActivity.this, R.raw.decembermm);
			}
		});
