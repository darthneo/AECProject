...
public class dat3PhilipinesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datphilipines3_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Philipines 
		        + " WHERE " + Database.COL_TYPE + "='Philipines3'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnJanuaryPH);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.januaryph);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnFebruaryPH);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.februaryph);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnMarchPH);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.marchph);
			}
		});
				
		Button buttonSound4 = (Button)findViewById(R.id.btnAprilPH);
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.aprilph);
			}
		});
				
		
		Button buttonSound5 = (Button)findViewById(R.id.btnMayPH);
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.mayph);
			}
		});

		
		Button buttonSound6 = (Button)findViewById(R.id.btnJunePH);
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.juneph);
			}
		});

		
		Button buttonSound7 = (Button)findViewById(R.id.btnJulyPH);
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.julyph);
			}
		});
		
		Button buttonSound8 = (Button)findViewById(R.id.btnAugustPH);
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.augustph);
			}
		});
		
		Button buttonSound9 = (Button)findViewById(R.id.btnSeptemberPH);
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.septemberph);
			}
		});
		
		Button buttonSound10 = (Button)findViewById(R.id.btnOctoberPH);
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.octoberph);
			}
		});
		
		Button buttonSound11 = (Button)findViewById(R.id.btnNovemberPH);
		buttonSound11.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.novemberph);
			}
		});
		
		Button buttonSound12 = (Button)findViewById(R.id.btnDecemberPH);
		buttonSound12.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3PhilipinesActivity.this, R.raw.decemberph);
			}
		});
