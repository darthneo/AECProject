...
public class dat3SingaporeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datsingapore3_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Singapore 
		        + " WHERE " + Database.COL_TYPE + "='Singapore3'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.januarysg);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.februarysg);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.marchsg);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.aprilsg);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.maysg);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.junesg);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.julysg);
			}
		});
		...
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.augustsg);
			}
		});
		...
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.septembersg);
			}
		});
		...
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.octobersg);
			}
		});
		...
		buttonSound11.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.novembersg);
			}
		});
		...
		buttonSound12.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3SingaporeActivity.this, R.raw.decembersg);
			}
		});
