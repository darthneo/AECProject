...
public class dat3VietnamActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datvietnam3_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Vietnam 
		        + " WHERE " + Database.COL_TYPE + "='Vietnam3'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.januaryvn);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.februaryvn);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.marchvn);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.aprilvn);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.mayvn);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.junevn);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.julyvn);
			}
		});
		...
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.augustvn);
			}
		});
		...
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.septembervn);
			}
		});
		...
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.octobervn);
			}
		});
		...
		buttonSound11.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.novembervn);
			}
		});
		...
		buttonSound12.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat3VietnamActivity.this, R.raw.decembervn);
			}
		});
