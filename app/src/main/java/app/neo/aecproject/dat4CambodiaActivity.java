...
public class dat4CambodiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datcambodia4_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Cambodia 
		        + " WHERE " + Database.COL_TYPE + "='Cambodia4'" 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.onekh);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.twokh);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.threekh);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.fourkh);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.fivekh);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.sixkh);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.sevenkh);
			}
		});
		...
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.eightkh);
			}
		});
		...
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.ninekh);
			}
		});
		...
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4CambodiaActivity.this, R.raw.tenkh);
			}
		});
