...
public class dat4MyanmarActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datmyanmar4_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Myanmar 
		        + " WHERE " + Database.COL_TYPE + "='Myanmar4'" 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.onemm);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.twomm);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.threemm);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.fourmm);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.fivemm);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.sixmm);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.sevenmm);
			}
		});
		...
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.eightmm);
			}
		});
		...
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.ninemm);
			}
		});
		...
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4MyanmarActivity.this, R.raw.tenmm);
			}
		});
