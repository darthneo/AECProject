...
public class dat4PhilipinesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datphilipines4_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Philipines 
		        + " WHERE " + Database.COL_TYPE + "='Philipines4'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnOnePH);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.oneph);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnTwoPH);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.twoph);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnThreePH);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.threeph);
			}
		});
				
		Button buttonSound4 = (Button)findViewById(R.id.btnFourPH);
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.fourph);
			}
		});
				
		
		Button buttonSound5 = (Button)findViewById(R.id.btnFivePH);
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.fiveph);
			}
		});

		
		Button buttonSound6 = (Button)findViewById(R.id.btnSixPH);
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.sixph);
			}
		});

		
		Button buttonSound7 = (Button)findViewById(R.id.btnSevenPH);
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.sevenph);
			}
		});
		
		Button buttonSound8 = (Button)findViewById(R.id.btnEightPH);
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.eightph);
			}
		});
		
		Button buttonSound9 = (Button)findViewById(R.id.btnNinePH);
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.nineph);
			}
		});
		
		Button buttonSound10 = (Button)findViewById(R.id.btnTenPH);
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4PhilipinesActivity.this, R.raw.tenph);
			}
		});
