...
public class dat4SingaporeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datsingapore4_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Singapore 
		        + " WHERE " + Database.COL_TYPE + "='Singapore4'" 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.onesg);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.twosg);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.threesg);
			}
		});
		...
		buttonSound4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.foursg);
			}
		});
		...
		buttonSound5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.fivesg);
			}
		});
		...
		buttonSound6.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.sixsg);
			}
		});
		...
		buttonSound7.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.sevensg);
			}
		});
		...
		buttonSound8.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.eightsg);
			}
		});
		...
		buttonSound9.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.ninesg);
			}
		});
		...
		buttonSound10.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat4SingaporeActivity.this, R.raw.tensg);
			}
		});
