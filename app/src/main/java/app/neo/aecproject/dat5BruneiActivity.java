...
public class dat5BruneiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datbrunei5_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Brunei 
		        + " WHERE " + Database.COL_TYPE + "='Brunei5'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnGoodbyeBN);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5BruneiActivity.this, R.raw.goodbyebn);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnSeeyoulaterBN);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5BruneiActivity.this, R.raw.seeyouagainbn);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnGoodnightBN);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5BruneiActivity.this, R.raw.goodnightbn);
			}
		});
