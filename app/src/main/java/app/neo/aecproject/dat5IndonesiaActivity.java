...
public class dat5IndonesiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datindo5_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Indonesia 
		        + " WHERE " + Database.COL_TYPE + "='Indonesia5'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnGoodbyeID);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5IndonesiaActivity.this, R.raw.goodbyeid);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnSeeyoulaterID);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5IndonesiaActivity.this, R.raw.seeyoulaterid);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnGoodnightID);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5IndonesiaActivity.this, R.raw.goodnightid);
			}
		});
