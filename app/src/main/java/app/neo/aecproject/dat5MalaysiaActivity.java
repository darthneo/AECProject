...
public class dat5MalaysiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datmalaysia5_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Malaysia 
		        + " WHERE " + Database.COL_TYPE + "='Malaysia5'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnGoodbyeMY);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5MalaysiaActivity.this, R.raw.goodbyemy);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnSeeyoulaterMY);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5MalaysiaActivity.this, R.raw.seeyouagainmy);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnGoodnightMY);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5MalaysiaActivity.this, R.raw.goodnightmy);
			}
		});
