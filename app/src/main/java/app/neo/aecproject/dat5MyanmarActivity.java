...
public class dat5MyanmarActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datmyanmar5_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Myanmar 
		        + " WHERE " + Database.COL_TYPE + "='Myanmar5'" 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5MyanmarActivity.this, R.raw.goodbyemm);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5MyanmarActivity.this, R.raw.seeyouagainmm);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5MyanmarActivity.this, R.raw.goodnightmm);
			}
		});
