...
public class dat5PhilipinesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datphilipines5_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Philipines 
		        + " WHERE " + Database.COL_TYPE + "='Philipines5'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnGoodbyePH);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5PhilipinesActivity.this, R.raw.goodbyeph);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnSeeyoulaterPH);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5PhilipinesActivity.this, R.raw.seeyoulaterph);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnGoodnightPH);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5PhilipinesActivity.this, R.raw.goodnightph);
			}
		});
