...
public class dat5SingaporeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datsingapore5_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Singapore 
		        + " WHERE " + Database.COL_TYPE + "='Singapore5'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5SingaporeActivity.this, R.raw.goodbyesg);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5SingaporeActivity.this, R.raw.seeyoulatersg);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5SingaporeActivity.this, R.raw.goodnightsg);
			}
		});
