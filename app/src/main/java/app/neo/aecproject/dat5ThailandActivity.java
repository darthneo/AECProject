...
public class dat5ThailandActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datthai5_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Thailand 
		        + " WHERE " + Database.COL_TYPE + "='Thailand5'" 
...
/*		Cursor mCursor2 = mDb.rawQuery("SELECT * FROM " + Database.TABLE_NAME 
		...
		//Media
		Button buttonSound1 = (Button)findViewById(R.id.btnGoodbyeth);
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5ThailandActivity.this, R.raw.goodbyeth);
			}
		});
		
		
		Button buttonSound2 = (Button)findViewById(R.id.btnSeeyoulaterth);
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5ThailandActivity.this, R.raw.seeyoulaterth);
			}
		});
				
		
		Button buttonSound3 = (Button)findViewById(R.id.btnGoodnightth);
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5ThailandActivity.this, R.raw.goodnightth);
			}
		});
