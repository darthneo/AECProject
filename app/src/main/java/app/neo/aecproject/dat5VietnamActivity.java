...
public class dat5VietnamActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datvietnam5_layout);
		...
		Cursor mCursor = mDb.rawQuery("SELECT * FROM " + Database.Vietnam 
		        + " WHERE " + Database.COL_TYPE + "='Vietnam5'" 
		...
		buttonSound1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5VietnamActivity.this, R.raw.goodbyevn);
			}
		});
		...
		buttonSound2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5VietnamActivity.this, R.raw.seeyoulatervn);
			}
		});
		...
		buttonSound3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				playSound(dat5VietnamActivity.this, R.raw.goodnightvn);
			}
		});
